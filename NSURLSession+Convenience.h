...
- (NSURLSessionDataTask *)sendRequestWithContract:(NSString *)contract action:(NSString *)action parameters:(NSDictionary *)parameters completion:(void(^)(id data, NSURLResponse *response))completion; // SOAP
